...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> _saveConfig() async {
    ...
    if (mounted) {
      ...
      await Provider.of<TutorProvider>(context, listen: false).refreshSettings();
  ...
  Widget build(BuildContext context) {
    final activeColor = const Color(0xFF7F5AF0); // Matching the global aesthetic
                      ...
                      children: [
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    'Google AI Studio API Key가 등록되지 않았거나 네트워크 연결이 유실되었을 경우, 정밀한 실시간 오프라인 모크 영작 피드백 엔진이 작동하여 회화 지도가 계속 이루어집니다.',
                                    style: GoogleFonts.outfit(
                                      fontSize: 13,
                                      color: const Color(0xFF94A1B2),
                                      height: 1.5,
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    'PC 로컬에 Ollama가 설치되어 있어야 합니다. Gemma 4 등의 가벼운 모델을 포팅한 뒤, 11434 포트를 열어 모바일 앱이나 웹 디버거에서 온디바이스 회화를 시뮬레이션할 수 있습니다.',
                                    style: GoogleFonts.outfit(
                                      fontSize: 13,
                                      color: const Color(0xFF94A1B2),
                                      height: 1.5,
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                color: (_mode == 'google' ? activeColor : const Color(0xFF00E5FF)).withOpacity(0.3),
                                blurRadius: 16,
